<template>
  <v-container class="text-center">
      ...
      <v-col cols="12" md="6">
        <v-sheet>
          ...
          <v-sheet class="font-weight-bold text-h5 pt-4">
            {{ recordStore.record.case.姓名 }}
          </v-sheet>
          <v-sheet class="text-h6 pt-2">
            {{ recordStore.record.case.主诉 }}
          </v-sheet>
        </v-sheet>
      </v-col>
      <v-col />
    ...
    <v-row>
      ...
      <v-col cols="12" md="2">
        <v-btn size="x-large" block class="font-weight-bold" :loading="isLoading" @click="nextCase">
          下一位患者
          <template #loader>
