...
const book = ref(bookStore.books[stateStore.bookScope.book])

// const chapters = computed(() => {
//   return stateStore.selectedBook === null
//     ? []
//     : [...Object.keys(bookStore.books[stateStore.selectedBook] || {})]
// })

// const sections = computed(() => {
//   if (stateStore.selectedChapter) {
//     return bookStore.books[stateStore.selectedBook][stateStore.selectedChapter] == {}
//       ? []
//       : [...Object.keys(bookStore.books[stateStore.selectedBook][stateStore.selectedChapter] || {})]
//   } else {
//     return []
//   }
// })
...
//       : [
//           ...Object.keys(
//             bookStore.books[stateStore.selectedBook][stateStore.selectedChapter][
//               stateStore.selectedSection
//             ] || {}
//           ),
//         ]
